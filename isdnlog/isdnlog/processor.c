    ...
    case AOC_INITIAL          : ID = OP = EH = MP = 0;
                                ...
                                switch (OP) {
                                  case 0x09 : /* activationStatusNotificationDiv (Rufumleitung an) */
                    				...
                    				case 0x02 : px1 = "CFNR"; break; /* Rufumleitung wenn niemand hîrt */
        ...
        case 0x04 : /* Bearer capability E-DSS1 */
                    ...
                    *px = 0;
                    ...
                    switch (c & 0x1f) {
                      ...
                      case 0x08 : px += sprintf(px, "Unrestricted digital information"); /* "uneingeschrÑnkte digitale Information" */
                                  call[chan].si1 = 7;
                                  call[chan].si11 = 0;
                                  strcpy(call[chan].service, "Data");
                                  break;

                      case 0x09 : px += sprintf(px, "Restricted digital information");  /* "eingeschrÑnkte digitale Information" */
                                  call[chan].si1 = 2;
                                  call[chan].si11 = 0;
                      ...
                      case 0x11 : px += sprintf(px, "Unrestricted digital information with tones/announcements"); /* "uneingeschrÑnkte digitale Ton-Inform." */
                                  call[chan].si1 = 3;
                                  call[chan].si11 = 0;
                                  break;
